...
module.exports = {
   ...
   */
  contracts_build_directory: path.join(__dirname,"client/src/build"), // this line changes the default storage for the smart contracts artifacts to be in a build folder inside the /src folder.
